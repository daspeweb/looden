...
Route::middleware(
    ...
    Route::group(['prefix' => 'api'], function (){
        ...
        Route::get('{slug}/{key}', '\Looden\Framework\Controller\APIController@show');
        Route::get('{slug}', '\Looden\Framework\Controller\APIController@index');
        Route::delete('{slug}/{key}', '\Looden\Framework\Controller\APIController@destroy');
        Route::delete('{slug}', '\Looden\Framework\Controller\APIController@destroyCollection');

        Route::post('{slug}/collection', '\Looden\Framework\Controller\APIController@upsertCollection');
        Route::post('{slug}', '\Looden\Framework\Controller\APIController@upsert');

        Route::put('{slug}/collection', '\Looden\Framework\Controller\APIController@upsertCollection');
        Route::put('{slug}/{key}', '\Looden\Framework\Controller\APIController@upsert');
